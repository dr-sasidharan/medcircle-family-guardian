    ...
    <div className="min-h-screen bg-background pb-24">
        ...
        <div className="px-4 mt-6">
          <div className="bg-card rounded-2xl border border-border p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Age {profile.age} · Blood Group {profile.blood_group}</p>
      ...
      <div className="px-4 mt-8">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-foreground">My Care Circle</h2>
          </div>
          <button
      ...
      <div className="px-4 mt-8 space-y-3">
        ...
        <button onClick={() => navigate("/pricing")}
          ...
          <p className="text-sm text-muted-foreground">Get unlimited medicines & caretaker access</p>
        </button>
      </div>
