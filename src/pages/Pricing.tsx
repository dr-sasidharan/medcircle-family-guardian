...
const plans = [
  ...
  },
  {
    ...
    price: "₹5",
    periodKey: "per_month",
    features: ["Unlimited medicines", "Caretaker dashboard", "SMS & WhatsApp alerts"],
    highlighted: true,
  },
  {
    key: "family_pro",
    price: "₹10",
    periodKey: "per_month",
    features: ["Everything in Family Plan", "AI health insights", "Drug interaction checker"],
    highlighted: false,
  },
  {
    key: "one_time",
    price: "₹15",
    periodKey: "once",
    features: ["Full parent setup", "No monthly commitment", "Guided onboarding call"],
    highlighted: false,
  },
];
