...
const DoctorSummary = () => {
  ...
  const handleShare = async () => {
    if (navigator.share) {
      try {
        await navigator.share({ title: "Doctor Visit Summary", text: summary });
      } catch {
        // user cancelled
      }
    } else {
  ...
  const handlePrint = () => {
    ...
    if (printWindow) {
      printWindow.document.write(`
        <html><head><title>Doctor Visit Summary</title>
        ...
        <p style="margin-top:2rem;font-size:0.75rem;color:#888">Generated by MedCircle · AI information is for awareness only.</p>
        </body></html>
      `);
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border">
        ...
        <h1 className="text-lg font-bold text-foreground">Pre-Doctor Visit Summary</h1>
      </div>
          ...
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-2">
                Generate an AI summary of your medicines, adherence, and suggested questions for your doctor.
              </p>
            </div>
            <button
